...
#+begin_src emacs-lisp
    ...
    ;;                           "/opt/homebrew/Cellar/sbcl/*/lib/sbcl/sbcl.core"))))
  ...
  ;; (setq inferior-lisp-program "/opt/homebrew/Cellar/sbcl/2.5.1/lib/bin/sbcl/sbcl.core")
#+end_src
*** slime
#+begin_src emacs-lisp
  ;; slime
  (use-package slime :defer t :config (setq inferior-lisp-program "/opt/sbcl/bin/sbcl"))
