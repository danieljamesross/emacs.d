...
this. But if we launch from the finder then we do. The `:if` statement accoutns
for this.
https://github.com/d12frosted/homebrew-emacs-plus?tab=readme-ov-file#injected-path
#+begin_src emacs-lisp
  (use-package exec-path-from-shell
    :if (and (not (string-match-p (regexp-quote  "/usr/local/bin:") (getenv "PATH")))
...
#+begin_src emacs-lisp
  ...
  (use-package all-the-icons-completion
    :hook (corfu-mode . all-the-icons-completion-mode)
    :after all-the-icons)
...
#+begin_src emacs-lisp
  ...
  (unless (member  "Iosevka" (font-family-list))
    ...
    (set-default-font "Iosevka Fixed" 14))
#+end_src
**** Emoji
#+begin_src emacs-lisp
  ;; set font for emoji
...
** eglot
#+begin_src emacs-lisp
  (use-package eglot :hook (prog-mode . eglot-ensure) :config (setq eglot-code-action-indicator ""))
#+end_src
*** eglot-ensure
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ;; slime
  (use-package slime :config (setq inferior-lisp-program "/opt/sbcl/bin/sbcl"))
...
#+begin_src emacs-lisp
  (use-package lms
    :config (setq lms-url "http://192.168.0.13:9000"
